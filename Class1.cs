...
namespace WristMenu
{
    ...
    class MenuPatch
    {
        static string[] buttons = new string[] { "Toggle Super Monke", "Material Gun", "Toggle Speed Boost", "Material All", "Turn Off Tag Freeze", "Toggle Beacon" };
        ...
        static bool MaterialToggled = false;
        ...
        public static int DefaultMaterial = 0;
