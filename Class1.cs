...
namespace WristMenu
{
    ...
    class MenuPatch
    {
                ...
                if (verified)
                {
                    ...
                    if (buttonsActive[1] == true)
                    {
                        ...
                        if (flag2)
                        {
                            ...
                            gameTable.Add("matIndex", DefaultMaterial);
                            player.SetCustomProperties(gameTable);
                            DefaultMaterial = DefaultMaterial + 1;
                            if (DefaultMaterial >= 7)
                            {
                                DefaultMaterial = 0;
                            }
                        ...
                        if (buttonsActive[5] == true)
                        {
                            ...
                            { 
                                ExitGames.Client.Photon.Hashtable gameTable = new ExitGames.Client.Photon.Hashtable();
                                gameTable.Add("matIndex", self);
                                PhotonNetwork.LocalPlayer.SetCustomProperties(gameTable);
                                self = self + 1;
                                if (self >= 7)
                                {
                                    self = 0;
        ...
        static void AddButton(float offset, string text)
        {
            ...
            newBtn.transform.localPosition = new Vector3(0.56f, 0f, 0.35f - offset);
            ...
            titleTransform.localPosition = new Vector3(0.064f, 0f, 0.134f - (offset / 2.55f));
        ...
        public static void Draw()
        {
            ...
            background.transform.localScale = new Vector3(0.1f, 1.3f, 1f);
            ...
            titleTransform.position = new Vector3(0.06f, 0f, 0.17f);
            titleTransform.rotation = Quaternion.Euler(new Vector3(180f, 90f, 90f));
